...
int main( void )
{
	...
	strcpy(j.carte.cases[0][0].typeJoueur, "NULL");
	j.carte.cases[0][0].idBonus=0;
	j.carte.cases[0][0].bombe=0;
	
	strcpy(j.carte.cases[0][1].typeCase, "JOUEUR");
	strcpy(j.carte.cases[0][1].typeJoueur, j.joueur[0].typeJoueur);
	j.carte.cases[0][1].idBonus=1;
	j.carte.cases[0][1].bombe=0;
	
	strcpy(j.carte.cases[1][0].typeCase, "JOUEUR");
	strcpy(j.carte.cases[1][0].typeJoueur, j.joueur[1].typeJoueur);
	j.carte.cases[1][0].idBonus=0;
	j.carte.cases[1][0].bombe=1;
	
	strcpy(j.carte.cases[1][1].typeCase, "mur.jpg");
	strcpy(j.carte.cases[1][1].typeJoueur, "NULL");
